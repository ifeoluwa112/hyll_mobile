...
class ContinueExploring extends StatelessWidget {
  const ContinueExploring({super.key});
          ...
          child: adventuresState.maybeMap(
            loading: (value) {
              if (value.adventures.isEmpty) {
                ...
                return _ContinueExploringItems(adventures: value.adventures);
              }
            },
            loaded: (value) {
              return _ContinueExploringItems(adventures: value.adventures);
...
class _ContinueExploringItems extends HookWidget {
  const _ContinueExploringItems({
